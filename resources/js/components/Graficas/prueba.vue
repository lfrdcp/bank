        ...
        <v-app>
            ...
            <v-card>
                ...
                <v-app-bar dark color="blue">
                    <v-toolbar-title>Gráfica de avance general</v-toolbar-title>
        ...
        data: function () {
            return {
                ...
                chartOptions: {
                    ...
                    title: {
                        text: 'Gráfica de avance general',
                        align: 'left',
                        margin: 10,
                        offsetX: 0,
                        offsetY: 0,
        ...
        methods: {
            updateChart() {
                setInterval(function () {
                    this.hola();
                    axios.get(`/grafica_general_index`).then(res => {
                        this.acumulado1 = res.data.acumulado;
                        this.meta1 = res.data.meta;
                    });
                    this.series =
                        [
                            {name: 'Meta', data: [this.meta1]},
