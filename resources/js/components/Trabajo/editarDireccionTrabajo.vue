            ...
            <v-form @submit.prevent="update" v-model="valid">
                <v-card>
                    <v-toolbar color="orange" dark>
                        <v-toolbar-title>Editar dirección del trabajo</v-toolbar-title>
...
<script>
    ...
    export default {
        ...
        created() {
            EventBus.$on('direccionTrabajo', data => {
                this.direccion = data;
            });
            EventBus.$on('dialogDireccionTrabajo', data => {
                this.dialog = data;
            });
        },
        methods: {
            update() {
                axios.put(`/trabajo/${this.direccion.id_direccion}`, this.direccion)
                    .then(res => {
                        console.log(res.data);
                    });
                swal({
                    title: "¡Editado!",
                    text: "Dirección del trabajo editada",
                    icon: "success",
                    button: "Esta bien",
                });
            },
