                        ...
                        <v-dialog v-model="ventanaOpciones" width="800">
                                        ...
                                        <v-col>
                                            <v-card color="light-green darken-1" dark>
                                                <v-card-text class="white--text">
                                                    ...
                                                    <v-list-item>
                                                        <v-list-item-content>
                                                            <v-list-item-content>• Todas las gestiones
                                                            </v-list-item-content>
                                                        </v-list-item-content>
                                                    </v-list-item>
                                                </v-card-text>
                                                ...
                                                <v-card-text class="white--text">
                                                    ...
                                                    <v-list-item>
                                                        <v-list-item-content>
                                                            ...
                                                            <v-list-item-content>• Gestor/Todos</v-list-item-content>
                                                        </v-list-item-content>
                                                    </v-list-item>
                                                </v-card-text>
                                            </v-card>
                            ...
                            <v-card>
                                ...
                                <v-toolbar color="light-green darken-1" dark>
                                    <v-icon>insert_drive_file</v-icon>
                                    <v-toolbar-title>Generar reporte de gestión</v-toolbar-title>
                                    ...
                                    <v-container>
                                        <v-row>
                                            ...
                                            <v-col v-if="filtrarOpcion2=='gestor'">
                                                <v-card>
                                                    <v-list dense>
                                                        <v-list-item-group color="light-green darken-1">
                                ...
                                <v-card-actions>
                                    <div class="flex-grow-1"></div>
                                    <v-btn color="light-green darken-1" dark @click="generar(); ventanaCargar = true">
                                        • Generar
                                    </v-btn>
        ...
        methods: {
            ...
            generar() {
                ...
                if (this.fecha !== '') {
                    ...
                    axios.post('/reporteGestionGeneral', params)
                        .then(res => {
                            ...
                            var nombreArchivo = 'GESTIONES_INTERNO_' + this.idDespacho + '_' + miFecha + '.csv';
                            download(res.data, nombreArchivo, 'csv');
                        });
                    new Noty({
                        type: 'success',
                        layout: 'bottomRight',
                        text: 'Se descargo reporte de gestión',
                        timeout: 7000,
                        progressBar: true,
                    }).show();
                }
